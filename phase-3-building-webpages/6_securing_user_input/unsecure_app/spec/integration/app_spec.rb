...
describe Application do
  ...
  context "POST /hello" do
    ...
    it "should not execute arbitrary JavaScript code" do
      response = post("/hello", name: '<script>window.alert("You\'ve been p0wn3d!!!!"); document.location.href="https://www.youtube.com/watch?v=34Ig3X59_qA";</script>')
